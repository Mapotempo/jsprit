...
public class InitialLoadConstraintTest {
    ...
    public void doBefore() {
        ...
        when(vehicle.getInitialCapacity()).thenReturn(Capacity.Builder.newInstance().addDimension(0, 5).build());
        ...
        Service s2 = Service.Builder.newInstance("s2").addSizeDimension(0, 3).setLocation(Location.newInstance("loc")).build();
        ...
        Delivery delivery = (Delivery) Delivery.Builder.newInstance("del").addSizeDimension(0, 3).setLocation(Location.newInstance("loc")).build();
        ...
        Shipment shipment2 = Shipment.Builder.newInstance("s2").addSizeDimension(0, 3).setPickupLocation(Location.Builder.newInstance().setId("pick").build()).setDeliveryLocation(Location.newInstance("del")).build();
        ...
        pickup_delivery_route = pdRouteBuilder.addService(delivery).addService(pickup).build();
    ...
    public void whenServiceRouteAndNewServiceFitsIn_itShouldReturnFulfilled() {
        ...
        when(s.getSize()).thenReturn(Capacity.Builder.newInstance().addDimension(0, 2).build());
    ...
    public void whenServiceRouteAndNewServiceDoesNotFitInBetweenStartAndAct1_itShouldReturnFulfilled() {
        stateManager.informInsertionStarts(Arrays.asList(serviceRoute), Collections.<Job>emptyList());
        Service s = mock(Service.class);
        Capacity newSize = Capacity.Builder.newInstance().addDimension(0, 3).build();
        when(s.getSize()).thenReturn(newSize);
        ServiceLoadActivityLevelConstraint loadConstraint = new ServiceLoadActivityLevelConstraint(stateManager);
    ...
    public void whenPDRouteRouteAndNewPickupFitsIn_itShouldReturnFulfilled() {
        ...
        when(s.getSize()).thenReturn(Capacity.Builder.newInstance().addDimension(0, 7).build());
        ServiceLoadRouteLevelConstraint loadconstraint = new ServiceLoadRouteLevelConstraint(stateManager);
    ...
    public void whenPDRoute_newPickupShouldFitInBetweenAct2AndEnd() {
        stateManager.informInsertionStarts(Arrays.asList(pickup_delivery_route), Collections.<Job>emptyList());
        Pickup s = mock(Pickup.class);
        Capacity newSize = Capacity.Builder.newInstance().addDimension(0, 8).build();
        when(s.getSize()).thenReturn(newSize);
        ServiceLoadActivityLevelConstraint loadConstraint = new ServiceLoadActivityLevelConstraint(stateManager);
    ...
    public void whenPDRoute_newPickupShouldNotFitInBetweenStartAndAct1() {
        stateManager.informInsertionStarts(Arrays.asList(pickup_delivery_route), Collections.<Job>emptyList());
        Pickup s = mock(Pickup.class);
        Capacity newSize = Capacity.Builder.newInstance().addDimension(0, 13).build();
        when(s.getSize()).thenReturn(newSize);
        ServiceLoadActivityLevelConstraint loadConstraint = new ServiceLoadActivityLevelConstraint(stateManager);
    ...
    public void whenPDRouteAndNewServiceDoesNotFitInBetweenAc1AndAct2_itShouldReturnFulfilled() {
        stateManager.informInsertionStarts(Arrays.asList(pickup_delivery_route), Collections.<Job>emptyList());
        Service s = mock(Service.class);
        Capacity newSize = Capacity.Builder.newInstance().addDimension(0, 9).build();
        when(s.getSize()).thenReturn(newSize);
        ServiceLoadActivityLevelConstraint loadConstraint = new ServiceLoadActivityLevelConstraint(stateManager);
