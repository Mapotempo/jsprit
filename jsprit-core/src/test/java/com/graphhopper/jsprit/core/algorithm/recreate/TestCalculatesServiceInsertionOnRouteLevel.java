...
public class TestCalculatesServiceInsertionOnRouteLevel {
    ...
    public void setup() {
        ...
        vehicle = VehicleImpl.Builder.newInstance("v1").setType(type).setStartLocation(Location.newInstance("0,0")).setReturnToDepot(true).setLatestArrival(100.).build();
        newVehicle = VehicleImpl.Builder.newInstance("v2").setType(type).setStartLocation(Location.newInstance("0,0")).setReturnToDepot(true).setLatestArrival(100.).build();
